...
class CoursesPage extends Component {
    ...
    dataDelete(){
        ...
        axios.post('/CourseDelete',{id:this.state.selectedRowId}).then((response)=>{
                    ...
                    <Menu title="Courses">
                        <Container>
                            <Row>
                                ...
                                <BootstrapTable wrapperClasses="table-responsive" keyField='id' data={ data } selectRow={selectRow} columns={ columns } pagination={ paginationFactory() } striped hover condensed />
                                </Col>
                            </Row>
                        </Container>
                    </Menu>
